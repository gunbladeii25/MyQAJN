...
TRAINING_DATA = [
    ...
    ("skor SK@S sekolah jauh lebih rendah daripada sasaran KPM", "Academic_Quality"),
    ...
    ("SK@S score shows major discrepancy with actual assessment", "Academic_Quality"),
    ...
    ("manipulasi data skor SK@S untuk mengelak audit Jemaah Nazir", "Administrative_Misconduct"),
    ...
    ("data manipulation in SK@S scores to mislead auditors", "Administrative_Misconduct"),
